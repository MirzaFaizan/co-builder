      ...
      <nav class="navbar navbar-expand-md mb-0">
        <div class="container-fluid flex-nowrap flex-sm-wrap">
          <div class="navbar-translate d-flex align-items-center">
            <h3 className="m-0 text-light font-weight-bold font-familt-sofia">
              CO-Builder
            </h3>
          </div>
              ...
              <li class="nav-item">
                <Link class="nav-link">
                  <i class="position-relative far fa-bell fa-2x">
                    <span class="header-notification-box badge-danger fixed-top position-absolute rounded-circle text-center">
                      10
                    </span>
                  </i>
                </Link>
